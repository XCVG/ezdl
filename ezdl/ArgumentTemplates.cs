...
namespace ezdl
{
    internal static class ArgumentTemplates
    {
        ...
        public static readonly string Facebook = "--compat-options embed-metadata,no-clean-infojson,no-keep-subs,mtime-by-default --force-ipv4 -ciw -o \"{OutputPath}/%(title).64s [%(id)s].%(ext)s\" --windows-filenames --restrict-filenames --add-metadata --merge-output-format mkv {Url}";
